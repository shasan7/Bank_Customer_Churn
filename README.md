...
We trained it for 100 iterations using the "Logloss" evaluation metric, and 'Balanced' value was passed to the auto_class_weights parameter to provide attention to the minority class, which is crucial for a dataset like ours with huge class imbalance.
